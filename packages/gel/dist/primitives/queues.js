...
export class LifoQueue {
    ...
    push(item) {
        ...
        if (!resolve) {
            throw new InternalClientError("resolve function was null or undefined when attempting to push.");
        }
        resolve(item);
    }
    get() {
        ...
        if (!promise) {
            throw new InternalClientError("promise was null or undefined when attempting to get.");
        }
        return promise;
    }
