...
import { LocalDateTime, LocalDate, LocalTime, Duration, RelativeDuration, DateDuration, LocalDateFromOrdinal, LocalDateToOrdinal, localDateInstances, } from "../datatypes/datetime";
    ...
    encode(buf, object, ctx) {
        if (ctx.hasOverload(this)) {
            ...
            if (typeof val != "bigint") {
                throw new InvalidArgumentError(`a bigint was expected out of a custom std::datetime codec`);
            }
            buf.writeInt32(8);
...
export class LocalDateTimeCodec extends ScalarCodec {
    ...
    encode(buf, object, ctx) {
        if (ctx.hasOverload(this)) {
            ...
            if (typeof us != "bigint") {
                throw new InvalidArgumentError(`a bigint was expected out of a custom cal::local_datetime codec`);
            }
            us -= BI_TIMESHIFT_US;
            buf.writeInt32(8);
    ...
    decode(buf, ctx) {
        ...
        return new LocalDateTime(date.getUTCFullYear(), date.getUTCMonth() + 1, date.getUTCDate(), date.getUTCHours(), date.getUTCMinutes(), date.getUTCSeconds(), date.getUTCMilliseconds(), us);
    }
}
...
export class LocalTimeCodec extends ScalarCodec {
    ...
    encode(buf, object, ctx) {
        if (ctx.hasOverload(this)) {
            ...
            if (typeof us != "bigint") {
                throw new InvalidArgumentError(`a bigint was expected out of a custom cal::local_time codec`);
            }
            buf.writeInt32(8);
            buf.writeBigInt64(us);
            return;
...
export function checkValidGelDuration(duration) {
...
export class DurationCodec extends ScalarCodec {
    ...
    encode(buf, object, ctx) {
        if (ctx.hasOverload(this)) {
            const us = ctx.preEncode(this, object);
            if (typeof us != "bigint") {
                throw new InvalidArgumentError(`a bigint was expected out of a custom std::duration codec`);
            }
            buf.writeInt32(16);
            buf.writeBigInt64(us);
            buf.writeInt32(0);
