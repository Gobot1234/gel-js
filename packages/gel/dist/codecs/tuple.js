...
export class TupleCodec extends Codec {
    ...
    encode(buf, object, ctx) {
        ...
        for (let i = 0; i < codecsLen; i++) {
            ...
            if (elem == null) {
                throw new MissingArgumentError(`element at index ${i} in tuple cannot be 'null'`);
            }
            else {
                try {
                    ...
                    if (e instanceof QueryArgumentError) {
                        throw new InvalidArgumentError(`invalid element at index ${i} in tuple: ${e.message}`);
                    }
                    else {
                        throw e;
                    }
