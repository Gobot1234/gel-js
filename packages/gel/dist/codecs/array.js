...
export class ArrayCodec extends Codec {
    ...
    encode(buf, obj, ctx) {
        if (!(this.subCodec instanceof ScalarCodec ||
            ...
            throw new InvalidArgumentError("only arrays of scalars or tuples are supported");
        }
        if (!Array.isArray(obj) && !isTypedArray(obj)) {
            throw new InvalidArgumentError(`an array was expected (got type ${obj.constructor.name})`);
        }
