...
export class PgVectorCodec extends ScalarCodec {
    tsType = "Float32Array";
    encode(buf, object, ctx) {
        object = ctx.preEncode(this, object);
        if (!(object instanceof Float32Array || Array.isArray(object))) {
            throw new InvalidArgumentError(`a Float32Array or array of numbers was expected, got "${object}"`);
        }
        if (object.length > PG_VECTOR_MAX_DIM) {
            throw new InvalidArgumentError("too many elements in array to encode into pgvector");
        }
        buf
        ...
        if (object instanceof Float32Array) {
            ...
            for (const el of object) {
                if (typeof el !== "number") {
                    throw new InvalidArgumentError(`elements of vector array expected to be a numbers, got "${el}"`);
                }
                buf.writeFloat32(el);
            }
        }
...
export class PgVectorHalfVecCodec extends ScalarCodec {
    tsType = "Float16Array";
    tsModule = "gel";
    encode(buf, object, ctx) {
        object = ctx.preEncode(this, object);
        if (!(isFloat16Array(object) || Array.isArray(object))) {
            throw new InvalidArgumentError(`a Float16Array or array of numbers was expected, got "${object}"`);
        }
        if (object.length > PG_VECTOR_MAX_DIM) {
            throw new InvalidArgumentError("too many elements in array to encode into pgvector");
        }
        ...
        if (isFloat16Array(object)) {
            ...
            for (let i = 0; i < object.length; i++) {
                if (typeof object[i] !== "number") {
                    throw new InvalidArgumentError(`elements of vector array expected to be a numbers, got "${object[i]}"`);
                }
                setFloat16(data, i * 2, object[i]);
            }
        }
...
export class PgVectorSparseVecCodec extends ScalarCodec {
    tsType = "SparseVector";
    tsModule = "gel";
    encode(buf, object, ctx) {
        let dims;
        ...
        if (ctx.hasOverload(this)) {
            ...
            if (!(object instanceof SparseVector)) {
                throw new InvalidArgumentError(`a SparseVector was expected, got "${object}"`);
            }
            dims = object.length;
        ...
        if (indexesLength > PG_VECTOR_MAX_DIM || indexesLength > dims) {
            throw new InvalidArgumentError("too many elements in sparse vector value");
        }
        buf
